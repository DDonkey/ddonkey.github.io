        ...
        this.insert = function(e) {
            ...
            if (t.getDocument().isNewLine(e)) {
                ...
                for (var v = r.row + 1; v <= l.row; ++v) {
                    var m = 0;
                    a = t.getLine(v);
                    for (var g = 0; g < a.length; ++g) if (a.charAt(g) == "	") m += h;
                    else {
                        if (a.charAt(g) != " ") break;
                        m += 1
                    }
...
function(e, t, n) {
    ...
    p = function(e, t) {
        ...
        this.getPreviewPosition = function(wrapData, scrollTop, lineHeight) {
            return this.doc.getPreviewPosition(wrapData, scrollTop, lineHeight)
        },
        this.getSelection = function() {
            return this.selection
        },
        ...
        this.$updateWrapData = function(e, t) {
            ...
            while (c <= t) {
                ...
                if (!f) a = this.$getDisplayTokens(i.stringTrimRight(n[c])),
...
function(e, t, n) {
    ...
    u = function(e) {
        ...
        /* getPreviewPosition Added by Sneezry */
        this.getPreviewPosition = function(wrapData, scrollTop, lineHeight) {
            var line = Math.ceil(scrollTop/lineHeight);
            var totalHeight = 0;
            var thisHeight = 0;
            var thisScreenHeight = 0;
            var index = 0;
            ...
            for(var i=0; i<allLines.length; i++){
                if( /^\s*$/.test(allLines[i]) ||
                        /^\s*\-+\s*$/.test(allLines[i]) ||
                        /^\s*#+/.test(allLines[i]) ){
                    if(totalHeight+thisScreenHeight+1 >= line){
                        return {
                            index: index,
                            position: (line-totalHeight)/(thisScreenHeight+1)
                        };
                    }

                    totalHeight += thisScreenHeight+1;
                    thisHeight = 0;
                    thisScreenHeight = 0;
                    index++;
                }
                    ...
                    thisHeight++;
                    thisScreenHeight += wrapData[i].length+1;
                }
            }
            return [0,0];
        },
...
ace.define("ace/virtual_renderer", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/event", "ace/lib/useragent", "ace/config", "ace/layer/gutter", "ace/layer/marker", "ace/layer/text", "ace/layer/cursor", "ace/scrollbar", "ace/renderloop", "ace/lib/event_emitter"],
function(e, t, n) {
    var r = e("./lib/oop"),
    i = e("./lib/dom"),
    s = e("./lib/event"),
    ...
    var m = function(e, t) {
        ...
        this.onResize = function(e, t, n, r) {
            ...
            if (r && (e || o.height != r)) {
                ...
                if (e || !o.scrollerHeight) o.scrollerHeight = o.height,
                this.$horizScroll && (o.scrollerHeight -= this.scrollBar.getWidth());
...
function(e, t, n) {
    ...
    u = function(e) {
        ...
        this.update = function(e) {
            var previewPosition = this.session.getPreviewPosition(this.session.$wrapData,
                                                            this.session.$scrollTop,
                                                            e.lineHeight);
            var top, height;
            if($('#wmd-preview > *').length){
                top = $($('#wmd-preview > *')[previewPosition.index]).position().top;
                console.log($('#wmd-preview > *')[previewPosition.index].style.marginTop)
                if($('#wmd-preview > *')[previewPosition.index+1]){
                    height = ($($('#wmd-preview > *')[previewPosition.index+1]).position().top-top);
                }
                else{
                    height = ($('#wmd-preview')[0].scrollHeight-top);
                }
                $('#wmd-preview').scrollTop(top+$('#wmd-preview').scrollTop()+height*previewPosition.position);
            }
            var t = {
                className: ""
            },
...
ace.define("ace/multi_select", ["require", "exports", "module", "ace/range_list", "ace/range", "ace/selection", "ace/mouse/multi_select_handler", "ace/lib/event", "ace/lib/lang", "ace/commands/multi_select_commands", "ace/search", "ace/edit_session", "ace/editor"],
function(e, t, n) {
    function h(e, t, n) {
