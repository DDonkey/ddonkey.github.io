    ...
    function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions, getString, getKey) {
        ...
        */
        ...
        function setupButton(button, isEnabled) {
            ...
            var i = button.getElementsByTagName("span")[0];
        ...
        function makeSpritedButtonRow() {
            ...
            var makeFAButton = function (id, className, title, XShift, textOp) {
                var button = document.createElement("li");
                button.className = "wmd-button";
                button.style.left = xPosition + "px";
                xPosition += 40;
                var buttonImage = document.createElement("i");
                buttonImage.className = "fa " + className +" white-txt";
            ...
            buttons.quote = makeFAButton("wmd-quote-button", "fa-quote-left", getString("quote"), "-60px", bindCommand("doBlockquote"));
            buttons.code = makeFAButton("wmd-code-button", "fa-code", getString("code"), "-80px", bindCommand("doCode"));
            buttons.image = makeFAButton("wmd-image-button", "fa-image", getString("image"), "-100px", bindCommand(function (chunk, postProcessing) {
                return this.doLinkOrImage(chunk, postProcessing, true);
            }));
            buttons.olist = makeFAButton("wmd-olist-button", "fa-list-ol", getString("olist"), "-120px", bindCommand(function (chunk, postProcessing) {
